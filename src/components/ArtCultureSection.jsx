...
import polaroidImg from "../assets/Art (2).png"; // main studio photo
import cam1 from "../assets/Art Curation Icons 01.svg";
import cam2 from "../assets/Art Curation Icons 02.svg";
import cam3 from "../assets/Art Curation Icons 03.svg";
import cam4 from "../assets/Art Curation Icons 04.svg";
  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto text-center mb-6">
        <h3 className="text-2xl md:text-2xl  text-[#1C1C1C]">"V take art where it belongs, to the people." - Vernita Verma</h3>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        ...
        <div className="pl-0 md:pl-5">
          ...
          <div className="text-[#1C1C1C] text-base md:text-lg leading-relaxed max-w-xl">
            <p className="mb-4"> Art isn’t meant to sit on distant walls — it’s meant to breathe,
              to travel, to belong.
            </p>
            <p className="mb-4"> Through every festival, every performance, and every gathering,
              we help stories find their stage and their people. V curates:</p>
