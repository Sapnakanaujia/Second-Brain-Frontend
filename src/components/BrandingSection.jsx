...
import polaroidImg from "../assets/Frame 32.png"; // main studio photo
import cam1 from "../assets/Vector 01.svg";
import cam2 from "../assets/Vector 02.svg";
import cam3 from "../assets/Vector 03.svg";
import cam4 from "../assets/Vector 04.svg";
  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto text-center mb-6">
        <h3 className="text-2xl md:text-2xl  text-[#1C1C1C]">"A brand is a voice, and a product is a souvenir." - Lisa Gansky</h3>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        ...
        <div className="pl-0 md:pl-5">
          ...
          <div className="text-[#1C1C1C] text-base md:text-lg leading-relaxed max-w-xl">
            <p className="mb-4">A brand isn’t just what you see — it’s what you remember, what
              you carry home, and what you trust.
            </p>
            <p className="mb-4"> We shape brands that people remember, return to, and fall in love
              with. V creates:</p>
